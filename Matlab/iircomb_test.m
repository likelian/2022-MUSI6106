...
for n=1:length(x);
	...
	Delayline(:,1)=[y(n,1);Delayline(1:delayInSamples-1,1)];
    Delayline(:,2)=[y(n,2);Delayline(1:delayInSamples-1,2)];
end;

audiowrite('/Users/likelian/Desktop/Audio_software/Output/Mat_iircomb_output.wav',y,Fs)